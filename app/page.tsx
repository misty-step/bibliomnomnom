...
export default function Home() {
  return (
    <div className="grid grid-rows-[var(--space-hero-inset)_1fr_var(--space-hero-inset)] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 bg-paper text-ink font-sans">
