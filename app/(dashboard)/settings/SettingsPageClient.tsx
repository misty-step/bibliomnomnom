 ...
 */
function SubscriptionCard({ priceIds }: { priceIds: StripePriceIds }) {
  ...
  const planName = getPlanNameFromPriceId(subscription.priceId, priceIds);
...
export default function SettingsPageClient({ priceIds }: Props) {
  return (
    <PageContainer>
      <section className="mx-auto max-w-2xl space-y-8">
        ...
        <div className="space-y-4">
          ...
          <SubscriptionCard priceIds={priceIds} />
        </div>
      </section>
    </PageContainer>
  );
